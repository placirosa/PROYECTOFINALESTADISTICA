...
# Frecuencia acumulada (Fi) indispensable para la Ojiva
...
# Rellenamos el área de abajo para generar la sombra morada suave
ax.fill_between(
    x_ojiva, 
    y_ojiva, 
    color="purple", 
...
# Personalización de títulos, etiquetas y ejes
